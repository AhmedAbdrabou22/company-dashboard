...
import { BaseInput } from "../../../shared/inputs/BaseInput";
import { BaseSelect } from "../../../shared/inputs/BaseSelect";
import { OutlineButton } from "../../../shared/buttons/OutlineButton";
import { PrimaryButton } from "../../../shared/buttons/PrimaryBtn";
import { addServiceProviderInitialValues, addServiceProviderValidationSchema, type AddServiceProviderFormValues } from "./addUserValidation";
import { BaseDateInput } from "../../../shared/inputs/BaseDateInput";
...
export const AddServiceProviderForm = () => {
    ...
    return (
        <div className="">
            {/* Page Header */}
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-gray-900">Add New Service Provider</h1>
